...
* Estimated flu activity from [Google Flu Trends](https://www.google.org/flutrends/intl/en_us/). Google is no longer publishing estimates of disease activity (as of August 20, 2015), but it continue to provide signal data for research purposes. See details on [the next chapter for Google Flu Trends](https://research.googleblog.com/2015/08/the-next-chapter-for-flu-trends.html).
    - Source: @Ginsberg.etal-Nature-2009, @Butler-Nature-2013, @Lazer.etal-Science-2014.
* [HealthMap Flu Trends](http://www.healthmap.org/flutrends/)
    - Source: @Freifeld.etal-2008
...
* [Project Tycho®](http://www.tycho.pitt.edu/): currently including data from all weekly notifiable disease (containing **influenza** and **pneumonia**) reports for the United States dating back to 1888.
    - Source: @Panhuis.etal-NEnglJMed-2013
...
+ **Index case**
    ...
    - Source: @Porta-dictionaryepidemiology-2014
    - Chinese: 指示病例
...
+ **Latent period**
    ...
    - Source: @Milwid.etal-FrontiersinPublicHealth-2016
    - Chinese: 潜伏期
...
+ **Generation time (interval)**
    ...
    - Source: @Milwid.etal-FrontiersinPublicHealth-2016, @Wallinga.Teunis-AmericanJournalofEpidemiology-2004
    - Chinese: 世代时间
...
+ **Serial interval**
    ...
    - Source: @Milwid.etal-FrontiersinPublicHealth-2016, @Fine-AmericanJournalofEpidemiology-2003.
    - Chinese: 传代间期
...
+ **Secondary attack rate**
    ...
    - Source: @Altman.etal-Encyclopediaofbiostatistics-2005
    - Chinese: 续发率
...
+ **Basic reproduction/reproductive number/ratio**
    ...
    - Source: @Wallinga.Teunis-AmericanJournalofEpidemiology-2004
    - Chinese: 基本再生数
...
+ **Case reproduction number**
    ...
    - Source: @Fraser-PLoSONE-2007, @Cori.etal-AmericanJournalofEpidemiology-2013
    - Chinese: 病例再生数
...
+ **Herd immunity threshold, Eradication fraction**
    ...
    - Source: @Mishra.etal-JournalofEpidemiologyandCommunityHealth-2010
    - Chinese: 群体免疫阈值
